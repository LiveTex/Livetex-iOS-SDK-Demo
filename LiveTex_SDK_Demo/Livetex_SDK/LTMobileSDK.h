...
/*!
 ...
 пойманый при выполнии операции в параллельном потоке очереди SDK. 
 @result ChatException ошибка сервиса чата. Может возникать в случае неверных атрибутов диалога.
 */
...
/*!
 ...
 @result ChatException ошибка сервиса чата. Может возникать при указании невалидного депертамента.
...
/*!
 ...
 @result operators список операторов для указанного депертамента.
